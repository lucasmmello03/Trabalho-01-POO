...
public class Main_teste {
    public static void main(String[] args) {
        ...
        Manutencao manutencaoPreventiva = new Manutencao(dataPreventiva, TipoManutencao.PREVENTIVA, 850.00, veiculo1.getQuilometragemAtual());
        ...
        Manutencao manutencaoCorretiva = new Manutencao(dataCorretiva, TipoManutencao.CORRETIVA, 1200.00, veiculo1.getQuilometragemAtual());
